...
**Dataset Variant**: CLID also includes a variant named CID-LIE (Controlled Illumination Dataset for Low-Light Image Enhancement), the **CID-LIE dataset** is available at the [![GitHub][(https://img.shields.io/badge/arxiv-paper-179bd3)](https://github.com/parrotufam/CID-LIE)]
